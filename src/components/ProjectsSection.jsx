    ...
    return(
        <section id='proyectos' className='projects-section'>
                ...
                <div className='container-projectsModal'>
                    <div onClick={toggleModal} className={`project-modal ${pasoModal0 == true ? 'visible' : 'fadeTop'} ${toggleExpandModal && modalId == 1 ? 'expandModal' : ''}`}>
                    ...
                    <div className={`project-modal scroll-content projects-in-progress ${pasoModal4 == true ? 'visible' : 'fadeTop'}`}>
                        <FaTools/>
