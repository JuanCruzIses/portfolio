...
function ProjectsSection (){
    ...
    const [pasoModal6, setPasoModal6] = useState(false)
        ...
        <section id='proyectos' className='projects-section'>
                ...
                <div className='container-projectsModal'>
                    <div onClick={toggleModal} className={`project-modal scroll-content ${pasoModal0 == true ? 'visible' : 'fadeTop'} ${toggleExpandModal && modalId == 1 ? 'expandModal' : ''}`}>
                        <img alt='logo-artGallery' className='image-project-modal mapear' src={require('../images/Art_Institute_of_Chicago_Logo.png')}></img>
                        <div id='1' className='shadow-box'></div>
                        <div className='overlay'>
                            <h6 className='title-project-modal'>Galeria de arte - Institute Chicago</h6>
                            <p className='p-project-modal'>Desafío técnico replica de galería de arte</p>
                            <p className='p-project-modal'>REACT | NextJs | APIs | Tailwind | TypeScript | Shadcn </p>
                            <a className='a-project-modal' rel="noopener noreferrer" target={'_blank'} href='https://challenge-banza-sigma.vercel.app/'>
                   ...
                   <div onClick={toggleModal} className={`project-modal scroll-content ${pasoModal2 == true ? 'visible' : 'fadeTop'} ${toggleExpandModal && modalId == 3 ? 'expandModal' : ''}`}>
                    ...
                    <div onClick={toggleModal} className={`project-modal ${pasoModal3 == true ? 'visible' : 'fadeTop'} ${toggleExpandModal && modalId == 4 ? 'expandModal' : ''}`}>
                    ...
                    <div onClick={toggleModal} className={`project-modal scroll-content ${pasoModal5 == true ? 'visible' : 'fadeTop'} ${toggleExpandModal && modalId == 6 ? 'expandModal' : ''}`}>
                        <img alt='logo-mapear' className='image-project-modal mapear' src={require('../images/logo-mapear.jpg')}></img>
                        <div id='6' className='shadow-box'></div>
                        <div className='overlay'>
                    ...
                    <div className={`project-modal scroll-content projects-in-progress ${pasoModal6 == true ? 'visible' : 'fadeTop'}`}>
                        <FaTools/>
